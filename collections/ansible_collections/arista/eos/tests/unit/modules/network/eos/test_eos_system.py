...
class TestEosSystemModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.arista.eos.plugins.modules.eos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.arista.eos.plugins.modules.eos_system.load_config')
